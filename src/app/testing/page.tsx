...
const Page = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => setIsPageVisible(true), 20);
    return () => clearTimeout(timer);
  }, []);

  return (
    <>
      <div className={`page-fade ${isPageVisible ? "page-visible" : ""}`}>
        <Header />
          ...
          <div className="flex justify-around my-auto pb-16 pt-48">
            <button className="access-btn relative">
              ...
              <span className="access-btn__center">
                ...
                <span className="access-btn__text access-btn__left">
            ...
            <button className="access-btn relative">
              ...
              <span className="access-btn__center">
                ...
                <span className="access-btn__text access-btn__right">
